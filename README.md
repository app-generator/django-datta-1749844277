...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-datta-1749844277) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-datta-1749844277.git
$ cd django-datta-1749844277
```
